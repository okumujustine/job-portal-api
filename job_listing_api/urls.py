...
from .views import (JobListView, JobDetailView, JobFilterView, LatestJobsView, ApplyJobView, EmployeeAppliedJobView,
                    GetEmployeeApplicationsView, JobCategoriesView, AdminUserJobListView, GetJobApplicationsView, EmployerStatsView)
...
urlpatterns = [
    ...
    path('admin/userjobs/', AdminUserJobListView.as_view(), name="admin-user-jobs"),
